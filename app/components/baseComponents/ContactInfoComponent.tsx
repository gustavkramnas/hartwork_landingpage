      ...
      {allInfo && (
        <div style={{ display: 'flex', flexDirection: 'row', padding: '20px', }}>
          <div style={{ flex: 2}}>
            ...
            <H6 style={{maxWidth: `calc(${theme.style.layout.sizes.maxWidth} / 2)`, paddingBottom: `100px`,}}>{contactInfo.fields.contactCompanyInfo}</H6>
            <H3 style={{paddingBottom: `10px`, }}>{contactInfo.fields.companyName}</H3>
