    ...
    <>
      {allInfo && (
        <div style={{ display: 'flex', flexDirection: 'row', padding: '20px', }}>
          <div style={{ flex: 2}}>
            <H1>
            <A style={{textDecoration: `underline`, color: theme.style.colors.secondary}} $white={!allInfo} href={`mailto:${contactInfo.fields.email}`}>HEJ!
              </A>
            </H1>
            <H6 style={{maxWidth: `calc(${theme.style.layout.sizes.maxWidth} / 2)`, paddingBottom: `100px`,}}>{contactInfo.fields.aboutCompany}</H6>
            <H3 style={{paddingBottom: `10px`, textDecoration: `underline`, }}>{contactInfo.fields.companyName}</H3>
          ...
          <div style={{ flex: 1, alignItems: `center`, display: `flex`, paddingTop: `40px` }}>
